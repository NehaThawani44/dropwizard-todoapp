...
public class ToDoRepository extends AbstractDAO<ToDo> {
    ...
    public void delete(ToDo toDo) {
        ...
        // Now, it's safe to delete the ToDo entity
        toDo = sessionFactory.getCurrentSession().get(ToDo.class, toDo.getId());
        toDo.getSubtasks().forEach(i->{sessionFactory.getCurrentSession().delete(i);});
